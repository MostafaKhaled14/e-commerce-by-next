...
import { checkedIn, forgotPasswordThunk } from "@/lib/features/authSlice/newPassowrdSlice";
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-100 flex items-center justify-center px-0 sm:px-4">
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 mx-6">
        <button onClick={() => router.push("/login")} className="px-3 py-1 mb-3 bg-gray-200 text-gray-800 rounded-xl hover:bg-gray-300 transition">
          ← Back
        </button>
        <h2 className="text-3xl font-bold text-center text-blue-600 mb-6">Reset Code</h2>
