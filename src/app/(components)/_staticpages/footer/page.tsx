    ...
    <>
      <footer className="bg-gray-900 text-white py-10 px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo + Description */}
          <div>
            <Link className="text-2xl font-bold mb-2 text-blue-400" href="/">
              MyShop
            </Link>
            <p className="text-sm text-gray-300">Your one-stop online shop for the latest and greatest products.</p>
          </div>
          {/* Quick Links */}
          <div>
        ...
        <div className="text-center text-sm text-gray-400 mt-10">&copy; {new Date().getFullYear()} MyShop. All rights reserved.</div>
      </footer>
    </>
  );
}
